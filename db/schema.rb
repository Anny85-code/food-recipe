...
ActiveRecord::Schema[7.0].define(version: 2022_05_17_210006) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "foods", force: :cascade do |t|
    t.string "name"
    t.float "measuring_unit"
    t.float "price"
  ...
  create_table "inventories", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "food_id"
    t.bigint "inventory_food_id"
    t.index ["food_id"], name: "index_inventories_on_food_id"
    t.index ["inventory_food_id"], name: "index_inventories_on_inventory_food_id"
